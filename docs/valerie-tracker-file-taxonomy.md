...
| `INTEGRATION-GUIDE.md` | [INTEGRATION] | Deleted from repo. Content was: auth swap design, integration boundary, 18-task checklist. Historical reference only. |
